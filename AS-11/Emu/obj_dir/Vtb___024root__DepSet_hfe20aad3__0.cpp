...
void Vtb___024root___eval_triggers__act(Vtb___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.set(1U, ((~ (IData)(vlSelfRef.clk)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__clk__0)));
    vlSelfRef.__VactTriggered.set(2U, ((~ (IData)(vlSelfRef.tb__DOT__WEB)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb__DOT__WEB__0)));
    vlSelfRef.__Vtrigprevexpr___TOP__clk__0 = vlSelfRef.clk;
    vlSelfRef.__Vtrigprevexpr___TOP__tb__DOT__WEB__0 
        = vlSelfRef.tb__DOT__WEB;
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
